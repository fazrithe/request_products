...
Route::group(['middleware' => ['auth']], function() {
    ...
    Route::get('historyGudang', [GudangController::class, 'history'])->name('history.gudang');
    ...
    Route::get('deleteRequest/{id}', [StockController::class, 'deleteRequest'])->name('request.delete');
...
Route::get('data-request', [StockController::class, 'dataRequest'])->name('data.request');
